...
/**
  * @brief  SOF callback.
  * @param  hhcd_USB_DRD_FS: HCD handle
  * @retval None
  */
void HAL_HCD_SOF_Callback(HCD_HandleTypeDef * hhcd_USB_DRD_FS)
{
  USBH_LL_IncTimer(hhcd_USB_DRD_FS->pData);
}
...
/**
  ...
  * @retval None
  */
void HAL_HCD_Connect_Callback(HCD_HandleTypeDef * hhcd_USB_DRD_FS)
{
  USBH_LL_Connect(hhcd_USB_DRD_FS->pData);
}
...
/**
  ...
  * @retval None
  */
void HAL_HCD_Disconnect_Callback(HCD_HandleTypeDef *hhcd_USB_DRD_FS)
{
  USBH_LL_Disconnect(hhcd_USB_DRD_FS->pData);
}
...
/**
  ...
  * @retval None
  */
void HAL_HCD_PortEnabled_Callback(HCD_HandleTypeDef *hhcd_USB_DRD_FS)
{
  USBH_LL_PortEnabled(hhcd_USB_DRD_FS->pData);
}
...
/**
  ...
  * @retval None
  */
void HAL_HCD_PortDisabled_Callback(HCD_HandleTypeDef *hhcd_USB_DRD_FS)
{
  USBH_LL_PortDisabled(hhcd_USB_DRD_FS->pData);
}
...
/**
  ...
  * @retval None
  */
void HAL_HCD_HC_NotifyURBChange_Callback(HCD_HandleTypeDef * hhcd_USB_DRD_FS,
                                         uint8_t chnum,
